...
Obsoletes: gsissh-clients < 5.6p1-3
Group: Applications/Internet
...
Obsoletes: gsissh-server < 5.6p1-3
...
* Wed Aug 10 2011 Mattias Ellert <mattias.ellert@fysast.uu.se> - 5.6p1-2
- Add patch from OSG to resolve threading problems in the server
- Based on openssh-5.6p1-34.fc15.1

* Sun Mar 06 2011 Mattias Ellert <mattias.ellert@fysast.uu.se> - 5.6p1-1
- Initial packaging
- Based on openssh-5.6p1-30.fc15
